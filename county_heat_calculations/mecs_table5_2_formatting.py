...
#
    ...
    def calculate_eu_share(self):
        ...
        #Format to only Conventional Boiler Use
        steam_fraction.loc[:, 'end_use'] = 'Conventional Boiler Use'

        steam_fraction.loc[:, 'other'] = 1

        steam_fraction.drop_duplicates(inplace=True)
